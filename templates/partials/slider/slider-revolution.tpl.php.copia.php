  	...
  	<ul>
        ...
        <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/custom-header-bg-f.jpg" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                     ...
                     data-x="<?php print $datax1; ?>"
										 ...
										 data-speed="1200"
										 data-start="1200"
                     data-easing="easeOutExpo"><img src="<?php print t('Whenever you need a valve...'); ?>  <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt=""></div>
        ...
        <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/custom-header-bg-c.jpg" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                     ...
                     data-x="<?php print $datax1; ?>"
										 ...
										 data-speed="1200"
										 data-start="2500"
                     data-easing="easeOutExpo"><img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt="">  <?php print t('Dealers in more than 70 countries'); ?>  <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt=""></div>
...
<li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
        ...
        <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/custom-header-bg-g.jpg" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                     ...
                     data-x="center""
										 ...
										 data-speed="300"
										 data-start="500"
                     data-easing="easeOutExpo"><img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt="">  <?php print t('<strong>The compliance deadline is a permanent concern, </strong> '); ?>  <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt=""></div>
                     ...
                     data-x="center"
										 ...
										 data-speed="1200"
										 data-start="1500"
                     data-easing="easeOutExpo"> <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt=""> <?php print t('<strong>which shows special attention CMO.</strong>'); ?>  <img src="<?php print path_to_theme(); ?>/templates/partials/slider/img/slides/slide-title-border.png" alt=""></div>
                     ...
                     data-x="center" data-hoffset="0"
										 ...
										 data-speed="1200"
										 data-start="3000"
                     data-easing="easeOutExpo">	CMO valves - NEXT to You ¡</div>
                     ...
                     <!--<div class="tp-caption sft stb visible-lg"
								 ...
								 <li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
									...
									<div class="tp-caption customin customout"
										...
										style="z-index: 8"><iframe src="//player.vimeo.com/video/99286058?title=0&amp;byline=0&amp;portrait=0&amp;color=ff9933&amp;autoplay=0" width="550" height="309" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
									</div>
                                ...
                                <li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
									...
									<div class="tp-caption customin customout"
										...
										data-autoplay="false"
										data-autoplayonlyfirsttime="false"
										style="z-index: 8"><iframe src="//player.vimeo.com/video/99948772?title=0&amp;byline=0&amp;portrait=0&amp;color=ff9933&amp;autoplay=0" width="750" height="462" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
									</div>
								...
								<li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
									...
									<div class="tp-caption customin customout"
										...
										data-autoplay="false"
										data-autoplayonlyfirsttime="false"
										style="z-index: 8"><iframe src="//player.vimeo.com/video/31305629?title=0&amp;byline=0&amp;portrait=0&amp;color=ff9933&amp;autoplay=0" width="550" height="309" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
									</div>
